...
coefW = rep(0,pW)
intercept<- -1.66 #0.2
savepath="htlgmm_simulate/logistic_pW_150/" #self-defined save path
if(pZ==10){
...
savefilename = paste0(savepath,"logistic_n_",n,"_pZ_",pZ,"_r_10.rds")
savefilenamea = paste0(savepath,"logistic_n_",n,"_pZ_",pZ,"_r_10ada.rds")
